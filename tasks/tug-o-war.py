...
def tug_o_war(teams):
    ...
    # return "Team 1 wins!"
    # return "Team 2 wins!"
    if   sum(teams[0]) > sum(teams[1]): return result[0]
    elif sum(teams[0]) < sum(teams[1]): return result[1]
    elif teams[0][0] > teams[1][-1]:    return result[0]
    elif teams[0][0] < teams[1][-1]:    return result[1]
